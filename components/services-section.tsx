                    ...
                    >
                        ...
                        <div className="grid gap-6 md:grid-cols-2">
                            ...
                            <SpotlightCard className="p-5">
                                ...
                                <p className="mt-2 text-sm leading-relaxed text-gray-400">A classified-ads and social marketplace serving a Next.js web app and a Flutter mobile app from one FastAPI backend, with AI ad posting, moderation, translation, and an in-product support assistant.</p>
                                <Link
                                    href="/projects/listurad"
                                    className="mt-3 inline-flex items-center gap-1 text-sm text-purple-300 transition-colors hover:text-pink-300"
                                >
                                    View Details
